...
* [x] Vehicle detail page (`/{brand}/{name-slug}-{uid}`, e.g. `/bmw/530i-m-sport-3fa8...` — redesigned in PR #40 to match the user-supplied real rendered HTML: gallery, spec highlights, specifications, description, a real Financing Calculator, a real page-view counter, real showroom card, similar cars; WhatsApp/Send Message/Test Drive/Apply for Financing/favorite/share remain real disabled controls pending Day 4/5 — see PR #39, #40)
