...
| -- | ------- | ------ | ----- | ------ | ------ |
| —  | FND-001 (`feature/project-init` branch, commit `25b6ae5`) | ⬜ Not reviewed — no remote configured yet, PR cannot be opened | 🟢 typecheck/lint/unit/E2E/build all passing | PR_OPEN (local only) | ⬜ |
